...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/marquis.abah/gigs/homepod_admin/node_modules/ufo/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marquis.abah/gigs/homepod_admin/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_r2kbO4 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_r2kbO4, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///Users/marquis.abah/gigs/homepod_admin/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
