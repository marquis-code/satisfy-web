...
const chatWithVendor = () => {
  // Hardcoded WhatsApp business link
  const whatsappBusinessLink = "https://wa.me/message/U5N3GG54TPMVG1";
  ...
  // Use the hardcoded WhatsApp business link with the message
  ...
  setTimeout(() => {
    ...
    if (document.hasFocus()) {
      showToast({
        ...
        message: "Try opening WhatsApp manually and searching for the business",
        type: "warning"
      });
