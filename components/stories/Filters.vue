<template>
    <div class="bg-white">
        ...
        <section aria-labelledby="filter-heading" class="grid items-center">
            ...
            <div v-if="showBulkFilter" class="border-t border-gray-200 py-10" id="disclosure-1">
                            ...
                            <div class="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                                ...
                                <div class="flex items-center text-base sm:text-sm">
                                    ...
                                    <label for="category-3"
                                        class="ml-3 min-w-0 flex-1 text-gray-600">Sweatshirts</label>
                                </div>
                                <div class="flex items-center text-base sm:text-sm">
            ...
            <div class="col-start-1 row-start-1 py-4">
                <div class="mx-auto flex max-w-7xl justify-end px-4 sm:px-6 lg:px-8">
                    <div class="relative inline-block">
                        <div class="flex">
                            <button @click="showMiniFilter = !showMiniFilter" type="button"
            ...
            -->
                ...
                -->
                                <a :class="[selectedFilter === 'popular' ? 'font-medium text-gray-900' : 'text-gray-500']" href="#" @click="handleSelectedItem('popular')"
                                    class="font-medium block px-4 py-2 text-sm" role="menuitem"
                                    tabindex="-1" id="menu-item-0">Most Popular</a>
                                <a :class="[selectedFilter === 'rating' ? 'font-medium text-gray-900' : 'text-gray-500']" href="#" @click="handleSelectedItem('rating')"
                                    class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                                    id="menu-item-1">Best Rating</a>
                                <a :class="[selectedFilter === 'newest' ? 'font-medium text-gray-900' : 'text-gray-500']" href="#" @click="handleSelectedItem('newest')"
                                    class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
...
const showBulkFilter = ref(false)
const showMiniFilter = ref(false)
const selectedFilter = ref('popular')
const handleSelectedItem = (itm: string) => {
    selectedFilter.value = itm
}
</script>
