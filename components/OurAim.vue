    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
      <div class="lg:pr-4 lg:pt-4">
        <div class="lg:max-w-lg">
          ...
          <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Our Aim</p>
          <p class="mt-6 text-lg/8 text-gray-600">To empower organizations in achieving their highest potential by providing comprehensive, data-driven insights, strategic communication, and operational expertise for meaningful local and global impact.</p>
          <div class="mt-8">
          ...
          <figure class="mt-16 border-l border-gray-200 pl-8 text-gray-600">
            ...
            <figcaption class="mt-6 flex gap-x-4 text-sm/6">
              <img src="https://images.unsplash.com/photo-1509783236416-c9ad59bae472?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80" alt="" class="size-6 flex-none rounded-full">
