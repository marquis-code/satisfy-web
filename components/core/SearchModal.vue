...
<template>
  <div v-if="isOpen"
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg">
      <!-- <input type="text" v-model="searchQuery" placeholder="Enter route name..."
        class="w-full border border-gray-300 p-2 rounded-md" autofocus /> -->
      ...
      <div v-if="queryResult.users.length" class="space-y-2.5">
      ...
      <div v-if="queryResult.stories.length" class="space-y-2.5">
