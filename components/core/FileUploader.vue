    ...
    <div v-else class="">
      <div v-if="editingIndex !== null" class="mb-4 p-4 rounded border shadow space-y-3">
        <div class="flex justify-between items-center">
          <p class="text-sm text-gray-800 font-bold">Character count should not exceed 380 characters.
            lines.</p>
          <p
            :class="`text-sm text-gray-800 font-bold ${editingText.length > 380 ? 'text-red-800' : editingText.length === 380 ? 'text-green-800' : ''}`">
        ...
        <div class="flex space-x-6">
          <div class="w-9/12">
            ...
            <div class="flex justify-end space-x-2">
              <button @click="saveEditing" :disabled="editingText.length > 380"
...
<template>
  <div class="">
    ...
    <div v-else class="">
      <div v-if="editingIndex !== null" class="mb-4 p-4 rounded border shadow space-y-3">
        <div class="flex justify-between items-center">
          <p class="text-sm text-gray-800 font-bold">Character count should not exceed 380 characters.</p>
          <p
            :class="`text-sm text-gray-800 font-bold ${editingText.length > 380 ? 'text-red-800' : editingText.length === 380 ? 'text-green-800' : ''}`">
            {{ editingText.length }}/380</p>
        </div>
      ...
      <div v-if="previousEditingIndex !== null || editingIndex !== null" class="mb-4 p-4 rounded border shadow space-y-3">
