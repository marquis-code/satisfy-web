<template>
  <main>
    <nav
      class="flex items-center justify-between border-x border-t px-4 sm:px-3 border-gray-400 border-b rounded-b-lg p-2.5">
      <div class="-mt-px flex w-0 flex-1">
        <button @click.prevent="previousPage" :disabled="currentPage === 1"
          class="inline-flex items-center pr-1 pt-4 text-sm disabled:opacity-50 font-medium text-gray-500  hover:text-gray-700">
      ...
      <div class="-mt-px flex w-0 flex-1 justify-end">
        <button @click.prevent="nextPage" :disabled="currentPage === totalPages"
          class="inline-flex disabled:opacity-50 items-center  pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
          Next
