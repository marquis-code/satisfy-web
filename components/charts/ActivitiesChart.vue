...
const chartOptions = ref({
  ...
  dataLabels: {
    ...
    style: {
      colors: ['#000000'] // You can change this color to whatever you prefer
    },
    offsetY: -30, // Adjust this value to move the data labels further up or down
  },
  plotOptions: {
    bar: {
      borderRadius: 10,
...
const chartOptions = ref({
  ...
  dataLabels: {
    ...
    offsetY: -20, // Adjust this value to move the data labels further up or down
  },
  plotOptions: {
    bar: {
      borderRadius: 10,
