  ...
  import { useFetchUserStoryChartData } from '@/composables/story/fetchChartData'
  
  // Initialize composable
  const { fetchChartData, chartDataObj, loading, setChartData, metaObj } = useFetchUserStoryChartData();
