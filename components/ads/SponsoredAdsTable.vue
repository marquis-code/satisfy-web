    ...
    <main>
        <div class="space-y-6">
          ...
          <div class="border-[0.5px] border-gray-50 rounded-lg">
            <dl class="mx-auto grid grid-cols-1 gap-px bg-gray-900/5 sm:grid-cols-2 lg:grid-cols-4 border-[0.5px] border-gray-50 rounded-lg">
                <div class="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 py-10 sm:px-6 xl:px-8">
                  ...
                  <dd class="w-full flex-none text-3xl font-medium leading-10 tracking-tight text-gray-900">{{adsList.length}}</dd>
                </div>
                <div class="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 py-10 sm:px-6 xl:px-8">
                ...
                <div class="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 text-white bg-[#00A1C1] px-4 py-6 sm:px-6 xl:px-8">
            ...
            <!-- <div class="mt-8 flow-root">
                ...
                <div class="mt-8 flow-root">
                  <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                          ...
                          <thead class="bg-gray-50">
                            <tr>
                              <th scope="col"
                                class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Client Name</th>
                              <th scope="col"
                                class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">File Upload</th>
                              <th scope="col"
                                class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Ads Link</th>
                              <th scope="col"
                              ...
                              <th scope="col"
                                class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Date Created</th>
                              <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                <span class="sr-only">Edit</span>
                              </th>
                            </tr>
                    ...
                    <!-- Pagination Controls -->
                    <nav  v-if="!loading && adsList.length" class="flex max-w-screen-2xl mx-10  items-center justify-between border border-gray-200 bg-white px-4 py-3\\\ sm:px-6" aria-label="Pagination">
                        ...
                        <div class="flex flex-1 justify-between sm:justify-end">
                          <button  :disabled="currentPage === 1" @click="previousPage" class="relative inline-flex items-center rounded-md bg-white px-3 py-4 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:outline-offset-0">Previous</button>
                          <button :disabled="currentPage === totalPages" @click="nextPage" href="#" class="relative ml-3 inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:outline-offset-0">Next</button>
                        </div>
                      </nav>
